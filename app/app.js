const GREENWAVE_VERSION="v1.17-charging-price-status";
...
document.addEventListener("DOMContentLoaded",()=>{ids.forEach(id=>els[id]=document.getElementById(id));initChargingUi();bind();loadSettings();loadHistory();initMap();syncSettingsUi();setFuelPanelMode();renderHistory();setStatus("Klar");});
